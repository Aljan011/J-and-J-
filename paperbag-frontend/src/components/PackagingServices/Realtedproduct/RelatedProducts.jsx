...
return ( <section className="related-products-section"> <h2 className="related-title">Related Products</h2>
  ...
  {isMobile ? (
    ...
    >
      {products.map((p) => {
        const colorPrices = Object.values(p.colors).map((c) => c.pricePerUnit);
    ...
    <div className="related-products-grid">
      {products.map((p) => {
        ...
        return (
          <Link href={`/packaging-services/${p.slug}`} key={p.slug} passHref>
            <article className="related-card">
              <div className="related-img-wrap">
                <Image
                  src={p.mainImage}
